...
- `gui/`: GUI implementation.
  ...
  - `core.py`: Session transitions, move history, and import/export.
  - `state.py`: Canonical GUI session state and analysis modes.
  - `analysis.py`: Analysis snapshots, candidate filtering, batch progression, and cache management.
  - `lifecycle.py`: Engine synchronization, analysis restarts, and engine replacement.
